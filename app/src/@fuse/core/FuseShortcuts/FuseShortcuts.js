        ...
        <MenuItem key={item.id}>
          <ListItemIcon className="min-w-40">
            {item.icon ? (
              ...
              /*<span className="text-20 font-semibold uppercase text-center">{item.title}</span>*/
            )}
          </ListItemIcon>
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-15 font-semibold">
                      {_item.title.includes(" ") ? _item.title.split(" ")[0] : _item.title}
                    </span>
                    {/*{_item.icon ? (
