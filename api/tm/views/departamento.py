...
from tm.serializers import departamentoPostSerializer
...
class departamentoList(APIView):
    """
    Lista todas las departamentoes o crea nuevas
    """
    ...
    def get(self, request, format=None):
        ...
        departamento_var = departamento.objects.all().filter(active = True)
        serializer_var = departamentoSerializer(departamento_var, many=True)
    ...
    def post(self, request, format=None):
        ...
        serializer_var = departamentoPostSerializer(data=request.data)
...
@authentication_classes([ExpiringTokenAuthentication])
class departamentoListDetail(APIView):  
    """
    Elimina o edita departamentoes específicas
    """
    permission_classes = [IsAuthenticated]
    ...
    def put(self, request, pk, format=None):
        ...
        departamento = self.get_object(pk)
        serializer = departamentoPostSerializer(departamento, data=request.data)
