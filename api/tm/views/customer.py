...
from tm.models import customer
from tm.serializers import customerSerializer
...
class customerList(APIView):
    """
    Lista todas las customeres o crea nuevas
    """
    ...
    def get(self, request, format=None):
        ...
        customer_var = customer.objects.all()
        serializer_var = customerSerializer(customer_var, many=True)
    ...
    def post(self, request, format=None):
        ...
        serializer_var = customerSerializer(data=request.data)
...
@authentication_classes([ExpiringTokenAuthentication])
class customerListDetail(APIView):  
    """
    Elimina o edita customeres específicas
    """
    permission_classes = [IsAuthenticated]
